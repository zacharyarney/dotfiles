" 'darkMentor.vim' -- Vim color scheme.
" Author:       Zachary Arney (zachary.arney@gmail.com)
" Description:  Essentially 'apprentice' by 
"               Romain Lafourcade (romainlafourcade@gmail.com)
" Last Change:  2020 Feb 14

" MADE-UP NAME    HEX        RGB                   XTERM  ANSI
" ========================================================================
" almost black    #121212    rgb(18, 18, 18)       233    background color
" darker grey     #1c1c1c    rgb(28, 28, 28)       234    8
...
let colors_name = "darkMentor"

if ($TERM =~ '256' || &t_Co >= 256) || has("gui_running")
  hi Normal         ctermbg=233  ctermfg=250  guibg=#121212 guifg=#bcbcbc cterm=NONE           gui=NONE
  hi LineNr         ctermbg=233  ctermfg=242  guibg=#121212 guifg=#6c6c6c cterm=NONE           gui=NONE
  hi FoldColumn     ctermbg=233  ctermfg=242  guibg=#121212 guifg=#6c6c6c cterm=NONE           gui=NONE
  hi Folded         ctermbg=233  ctermfg=242  guibg=#121212 guifg=#6c6c6c cterm=NONE           gui=NONE
  hi MatchParen     ctermbg=238  ctermfg=233  guibg=#444444 guifg=#121212 cterm=NONE           gui=NONE
  hi signColumn     ctermbg=233  ctermfg=242  guibg=#121212 guifg=#6c6c6c cterm=NONE           gui=NONE

  set background=dark

  hi Boolean          ctermbg=NONE ctermfg=208  guibg=NONE    guifg=#ff8700 cterm=NONE           gui=NONE
  ...
  hi Conditional      ctermbg=NONE ctermfg=73   guibg=NONE    guifg=#5fafaf cterm=NONE           gui=NONE
  ...
  hi Keyword          ctermbg=NONE ctermfg=103  guibg=NONE    guifg=#8787af cterm=NONE           gui=NONE
  ...
  hi ErrorMsg         ctermbg=131  ctermfg=234  guibg=#af5f5f guifg=#1c1c1c cterm=NONE           gui=NONE
  ...
  hi TabLineSel       ctermbg=101  ctermfg=234  guibg=#87875f guifg=#1c1c1c cterm=NONE           gui=NONE
  ...
  hi CursorLineNr     ctermbg=234  ctermfg=73   guibg=#1c1c1c guifg=#5fafaf cterm=NONE           gui=NONE
  ...
  hi Visual           ctermbg=234  ctermfg=110  guibg=#1c1c1c guifg=#8fafd7 cterm=reverse        gui=reverse
  ...
  hi DiffAdd          ctermbg=234  ctermfg=108  guibg=#1c1c1c guifg=#87af87 cterm=reverse        gui=reverse
  hi DiffChange       ctermbg=234  ctermfg=103  guibg=#1c1c1c guifg=#8787af cterm=reverse        gui=reverse
  hi DiffDelete       ctermbg=234  ctermfg=131  guibg=#1c1c1c guifg=#af5f5f cterm=reverse        gui=reverse
