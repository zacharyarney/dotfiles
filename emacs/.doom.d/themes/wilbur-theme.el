;;; wilbur.el --- inspired by doom-wilmersdorf-theme inspired by Atom City Lights -*- no-byte-compile: t; -*-
(require 'doom-themes)
...
(defcustom wilbur-padded-modeline doom-themes-padded-modeline
...
;;
(def-doom-theme wilbur
  "A dark theme inspired by Atom City Lights"

  ;; name        default   256       16
  ((bg         '("#1f2024" "#1f2024" nil            ))
   (bg-alt     '("#282b33" "#282b33" nil            ))
   ...
   (-modeline-pad
    (when wilbur-padded-modeline
      (if (integerp wilbur-padded-modeline) wilbur-padded-modeline 4)))
