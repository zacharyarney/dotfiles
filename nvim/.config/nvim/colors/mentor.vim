...
" ========================================================================
" almost black    #1c1c1c    rgb(28, 28, 28)       234    background color
" darker grey     #262626    rgb(38, 38, 38)       235    8
...
if ($TERM =~ '256' || &t_Co >= 256) || has("gui_running")
  ...
  hi MatchParen     ctermbg=238  ctermfg=234  guibg=#444444 guifg=#1c1c1c cterm=NONE           gui=NONE
  ...
  hi CursorLineNr     ctermbg=235  ctermfg=73   guibg=#262626 guifg=#5fafaf cterm=NONE           gui=NONE
  hi CursorLine       ctermbg=235  ctermfg=NONE guibg=#262626 guifg=NONE    cterm=NONE           gui=NONE
  ...
  hi Function         ctermbg=NONE ctermfg=101  guibg=NONE    guifg=#87875f cterm=NONE           gui=NONE
