...
" let s:p.normal.left = [ [ s:base2, s:blue ], [ s:base00, s:base03 ] ]
let s:p.normal.left = [ [ s:base03, s:ocre ] ]
let s:p.normal.right = [ [ s:base03, s:ocre ], [ s:base03, s:ocre ] ]
let s:p.inactive.right = [ [ s:base02, s:base03 ], [ s:base02, s:base03 ] ]
let s:p.inactive.left =  [ [ s:base02, s:base03 ], [ s:base02, s:base03 ] ]
" let s:p.insert.left = [ [ s:base2, s:green ], [ s:base00, s:base03 ] ]
let s:p.insert.left = [ [ s:base03, s:ocre ] ]
" let s:p.replace.left = [ [ s:base2, s:red ], [ s:base00, s:base03 ] ]
let s:p.replace.left = [ [ s:base03, s:ocre ] ]
" let s:p.visual.left = [ [ s:base2, s:magenta ], [ s:base00, s:base03 ] ]
let s:p.visual.left = [ [ s:base03, s:ocre ] ]
let s:p.normal.middle = [ [ s:base03, s:ocre ] ]
